 ...
 */
  ...
  //  if (str != str.equalsIgnoreCase(str.charAt(0)));
       ...
       if (!(str.equalsIgnoreCase("m") || str.equalsIgnoreCase( "t") ||
           ...
           /*
           if ((!str.equalsIgnoreCase("m") || !str.equalsIgnoreCase( "t") || !str.equalsIgnoreCase("w") ||
           !str.equalsIgnoreCase("f") || !str.equalsIgnoreCase("s"))) { --> Wrong -->
           this is saying if it's not one, it can still be others.
            */
